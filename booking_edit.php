...
if (isset($_POST['update_btn'])) {
    ...
    if (!isValidDate($formatted_booking_date)) {
        ...
        $update_query = "UPDATE booking 
                         SET booking_Date='$formatted_booking_date', time='$time', Type_Of_Service='$type_of_service', Vehicle_Type='$type', phone='$phone', Referral='$referral', Cust_Id='$cust_id', Manager_Id='$manager_id'
                            ...
                            <div class="form-group">
                                <label for="Vehicle_Type">Vehicle Type:</label>
                                    <select class="form-control" id="Vehicle_Type" name="Vehicle_Type" required>
                                            <option value="Bike"<?php if ($type == "Bike") echo " selected"; ?>>Bike</option>
                                            <option value="Car"<?php if ($type == "Car") echo " selected"; ?>>Car</option>
                                            <option value="Jeep"<?php if ($type == "Jeep") echo " selected"; ?>>Jeep</option>
                                            ...
                                            <option value="TukTuk"<?php if ($type == "TukTuk") echo " selected"; ?>>TukTuk</option>
                                            <option value="Lorry"<?php if ($type == "Lorry") echo " selected"; ?>>Lorry</option>
