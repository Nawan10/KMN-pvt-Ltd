                            ...
                            <div class="modal-body">
                                ...
                                <form action="generate_report.php" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- <input type="text" class="form-control" id="Service_Revenue" name="Service_Revenue" readonly value="<?php echo $serviceRevenue ?>"> -->
                                    </div>
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        //This field is not required for displaying individual instock values 
                                    </div>  -->
                                    ...
                                    <!-- <div class="form-group">
                                        <label for="InStock">InStock:</label>
                                        <input type="text" class="form-control" id="InStock" name="InStock" required readonly>
                                    </div> -->
