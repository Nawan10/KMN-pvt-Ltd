...
if (isset($_POST['add_btn'])) {
    ...
    $insert_customer_query = "INSERT INTO customer (Cust_Id, First_name, Last_name, Address, Phone, Email, Referral, `Manager_Id`, User_Id) 
                                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";

    $stmt_add_customer = mysqli_prepare($connect, $insert_customer_query);

    // Bind parameters
    mysqli_stmt_bind_param($stmt_add_customer, "sssssssss", $cust_id, $first_name, $last_name, $address, $phone, $email, $referral, $manager_id, $user_id);
