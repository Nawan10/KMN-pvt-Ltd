...
if (isset($_POST['update_btn'])) {
    ...
    $update_query = "UPDATE customer
                     SET first_name=?, last_name=?, address=?, phone=?, email=?, referral=?
                     WHERE Cust_id=?";
    $stmt = mysqli_prepare($connect, $update_query);
    // Bind parameters
    mysqli_stmt_bind_param($stmt, "sssissi", $updated_first_name, $updated_last_name, $updated_address, $updated_phone, $updated_email, $updated_referral,  $edit_id);
    mysqli_stmt_execute($stmt);
